...
public interface ConstantsRover {
    //For Encoders
    ...
    double COUNTS_PER_MOTOR_REV_ARM = 1126;
    double ARM_GEAR_REDUCTION = 10.0;
    double     COUNTS_FOR_ARM         = (COUNTS_PER_MOTOR_REV_ARM * ARM_GEAR_REDUCTION)/
            (WHEEL_DIAMETER_INCHES * 3.1415);
    ...
    double SAMPLE_SLIDE_SPEED = 0.5;
    double MAIN_ARM_SPEED = 0.25;

    double LATCH_SPEED = 1.0;
    double COLLECTOR_ARM_SPEED = 0.7;
    ...
    //How many inches we need to go toward target
